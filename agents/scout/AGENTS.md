...
### Current Status
**Paused until explicitly re-enabled.** All scheduled runs for idea analysis are disabled. Do not run trending-product research or TikTok idea scoring unless Atlas or Chris explicitly re-enables you.
<!-- ROLE-SPECIFIC:END -->
